...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Evaluation metrics.} Purpose-built benchmarks (e.g. Reflection-Bench\cite{reflection-bench}) and small PAL puzzles\cite{vanDitmarsch2007DEL} should measure contradictions avoided, redundant actions, or success rates on epistemic puzzles.
  \item \textbf{Human-agent common ground.} Extending the framework to reason about the user's knowledge could support richer dialogue strategies and aligns with prior discourse modelling\cite{Agotnes2023QuantifyingCommonKnowledge}.
